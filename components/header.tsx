      ...
      <div className="flex items-center gap-6">
              ...
              <div className="max-h-[300px] overflow-y-auto">
                {notifications.length === 0 ? (
                  ...
                  notifications.map((n) => (
                    ...
                    >
                      <div
                        className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${n.type === "sale" ? "bg-green-100 text-green-600" : n.type === "alert" ? "bg-red-100 text-red-600" : "bg-blue-100 text-blue-600"}`}
                      >
                        {n.type === "sale" ? (
        ...
        {profile &&
          (profile.role === "admin" || profile.role === "organizer") && (
            <Link
              href="/events/new"
              className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all shadow-sm flex items-center gap-2"
            >
