      ...
      <div className="max-w-md mx-auto space-y-6">
        <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm text-center">
          ...
          <p className="text-sm text-slate-500 mb-6">
            Enter the Ticket ID or use a connected barcode scanner.
          </p>
        ...
        {result && (
          <div
            className={`p-6 rounded-xl border flex flex-col items-center text-center ${result.status === "success" ? "bg-green-50 border-green-200" : "bg-red-50 border-red-200"}`}
          >
