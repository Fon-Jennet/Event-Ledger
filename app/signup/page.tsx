      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-sm border border-slate-200 sm:rounded-xl sm:px-10">
          ...
          <div className="bg-purple-50 rounded-lg p-4 mb-6 border border-purple-100 flex items-start gap-3">
             <div className="mt-0.5"><Sparkles className="w-5 h-5 text-purple-600" /></div>
             <div>
                <h4 className="text-sm font-bold text-purple-900 mb-1">Fast & Secure</h4>
                <p className="text-xs text-purple-700 leading-relaxed">Join thousands of users organizing and attending events. One click is all it takes to get started.</p>
             </div>
          </div>
          ...
          <form className="space-y-6 mb-6" onSubmit={handleEmailSignUp}>
            ...
            <div>
              ...
              >
                {isSigningIn ? <Loader2 className="w-5 h-5 animate-spin" /> : "Sign up"}
              </button>
            </div>
          </form>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center text-sm text-slate-500 mt-4">
              Note: Email/Password signup might need to be enabled in Firebase settings.
            </div>
          </div>
